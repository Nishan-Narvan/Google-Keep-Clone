...
const Pomodoro = ({mode}) => {
  ...
  return (
    <div className="relative flex flex-1 w-full h-full">
      ...
      {/* Hourglass Icon */}
      {isRunning && (
        <FaHourglassHalf className="absolute bottom-25 hover:text-[#285639] hover:scale-130 transform transition-all duration-400 ease-in-out  left-67 ml-2 text-5xl text-gray-300 animate-pulse z-10" />
      )}
    </div>
  );
};
